...
train_3D_mapping_file_path = './data/kitti/data_file/train_mapping.txt'
kitti_3D_rand_file_path = './data/kitti/data_file/train_rand.txt'
train_3D_file_path = './data/kitti/data_file/split/train.txt'
val_3D_file_path = './data/kitti/data_file/split/val.txt'

kitti_raw_data_dir = './data/kitti/raw_data'
save_kitti_raw_file_name = './data/kitti/data_file/split/train_raw.txt'
